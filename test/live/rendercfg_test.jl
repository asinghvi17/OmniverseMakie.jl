...
@testset "live render-config (camera + lights) on open stage (subprocess)" begin
    exitcode, output = run_ovrtx_subprocess(_M21_RENDERCFG_PROG; timeout = 1800, retries = 2, ready_marker = "OPENS_AFTER_BASELINE=")
